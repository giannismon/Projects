...
| [Terraform Azure AKS](./Terraform_Azure_AKS) | Deploys an AKS cluster with Terraform modules — system and user node pools, cluster autoscaler, managed identity, one tfvars file per environment |
